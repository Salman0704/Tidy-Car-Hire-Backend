    ...
    getAllInquiry: async(req,res)=>{
        try{
            ...
            serverValidation(res,{"message":"server error has occured","errors":errors.array()})  
                ...
                const inquiryList= await inquiryModel.find()
    ...
    getUnresolvedInquiry: async(req, res)=>{
        try{
            ...
            serverValidation(res,{"message":"server error has occured","errors":errors.array()})  
                ...
                const inquiryList= await inquiryModel.find({"recognised":false})
    ...
    editInquiryByID: async(req,res)=>{
        try{
            ...
            serverValidation(res,{"message":"server error has occured","errors":errors.array()})  
                ...
                const data=req.body;
                const inquiryData= await inquiryModel.findByIdAndUpdate(id, data,{new:true});
    ...
    deleteInquiryByID: async(req,res)=>{
        try{
            ...
            serverValidation(res,{"message":"server error has occured","errors":errors.array()})  
                ...
                const id= req.params.id;
                const inquiryData= await inquiryModel.findByIdAndDelete(id)
    ...
    addCar:async(req, res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const carDetails=await carData.save()
                if(carDetails){
    ...
    editCar:async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const id= req.params.id;
                const data= req.body;
                const carDetails= await serviceModel.findByIdAndUpdate(id, data, {new:true})
    ...
    getUserBooking: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const bookingList= await bookingModel.find({"user_email":user_email})
    ...
    getBookingByID: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const bookingDetails= await bookingModel.findById(booking_id);
    ...
    deleteBooking: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const booking_id=req.params.id;
                const bookingData= await bookingModel.findByIdAndDelete(booking_id);
    ...
    addTestimonial: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const data= req.body;
                const testimonialData=new testimonialModel(data)
                const testimonialDetails=await testimonialData.save()
    ...
    deleteTestimonial: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const id= req.params.id;
                const testimonialDetails= await testimonialModel.findByIdAndDelete(id)
    ...
    addLogo: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const data= req.body;
                const logoData= new logoModel(data);
                const logoDetails= await logoData.save();
    ...
    deleteLogo: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const id= req.params.id;
                const logoDetails= await logoModel.findByIdAndDelete(id);
    ...
    getLogoById: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const id= req.params.id;
                const logoItem= await logoModel.findById(id)
    ...
    addBlog: async(req,res)=>{
        try{
            ...
            if(!errors.isEmpty()){
                ...
                const blogDetails= await blogData.save()
